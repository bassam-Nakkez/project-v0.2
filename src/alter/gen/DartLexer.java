...
public class DartLexer extends Lexer {
	...
	public static final int
		...
		NetworkImage=83, FileImage=84, File=85, ListView=86, ItemBuilder=87, ItemCount=88, 
		Physics=89, ShrinkWrap=90, AddAutomaticKeepAlives=91, AddRepaintBoundaries=92, 
		AddSemanticIndexes=93, BuildContext=94, AlwaysScrollableScrollPhysics=95, 
		BouncingScrollPhysics=96, ClampingScrollPhysics=97, NeverScrollableScrollPhysics=98, 
		CP=99, DOT=100, E=101, EE=102, EGT=103, GT=104, LE=105, LL=106, LLE=107, 
		LT=108, MIN=109, MINMIN=110, MOD=111, MODE=112, MUL=113, MULE=114, NE=115, 
		OB=116, OP=117, P=118, PE=119, POUND=120, PP=121, Q=122, QD=123, QDD=124, 
		QQ=125, MIE=126, SCO=127, DIV=128, SLE=129, TE=130, POW=131, COT=132, 
		START=133, END=134, AA=135, AND=136, ANDE=137, AT=138, B=139, NOT=140, 
		OR=141, BE=142, CB=143, CO=144, COM=145, ARROW=146, ASSERT=147, BREAK=148, 
		CASE=149, CATCH=150, CLASS=151, CONST=152, CONTINUE=153, DEFAULT=154, 
		DO=155, ELSE=156, ENUM=157, EXTENDS=158, FALSE=159, FINAL=160, FINALLY=161, 
		FOR=162, IF=163, IN=164, IS=165, NEW=166, NULL=167, RETHROW=168, RETURN=169, 
		SUPER=170, SWITCH=171, THIS=172, THROW=173, TRUE=174, TRY=175, VAR=176, 
		VOID=177, WHILE=178, WITH=179, ABSTRACT=180, AS=181, COVARIANT=182, DEFERRED=183, 
		DYNAMIC=184, EXPORT=185, EXTENSION=186, EXTERNAL=187, FACTORY=188, FUNCTION=189, 
		GET=190, IMPLEMENTS=191, IMPORT=192, INTERFACE=193, LATE=194, LIBRARY=195, 
		OPERATOR=196, MIXIN=197, PART=198, REQUIRED=199, SET=200, STATIC=201, 
		TYPEDEF=202, AWAIT=203, YIELD=204, ASYNC=205, HIDE=206, OF=207, ON=208, 
		SHOW=209, SYNC=210, NATIVE=211, OVERRIDE=212, BOOL_VALUE=213, INT_NUM=214, 
		FLOAT_NUM=215, DOUBLE_NUM=216, HEXDIGIT=217, BOOLE_TYPE=218, STRING=219, 
		STRING_singl=220, ID=221, COMMENT=222, MULTI_LINE_COMMENT=223, WS=224;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"ClampingScrollPhysics", "NeverScrollableScrollPhysics", "CP", "DOT", 
			"E", "EE", "EGT", "GT", "LE", "LL", "LLE", "LT", "MIN", "MINMIN", "MOD", 
			"MODE", "MUL", "MULE", "NE", "OB", "OP", "P", "PE", "POUND", "PP", "Q", 
			"QD", "QDD", "QQ", "MIE", "SCO", "DIV", "SLE", "TE", "POW", "COT", "START", 
			"END", "AA", "AND", "ANDE", "AT", "B", "NOT", "OR", "BE", "CB", "CO", 
			"COM", "ARROW", "LETTER", "DIGIT", "EXPONENT", "ASSERT", "BREAK", "CASE", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"QD", "QDD", "QQ", "MIE", "SCO", "DIV", "SLE", "TE", "POW", "COT", "START", 
			"END", "AA", "AND", "ANDE", "AT", "B", "NOT", "OR", "BE", "CB", "CO", 
			"COM", "ARROW", "ASSERT", "BREAK", "CASE", "CATCH", "CLASS", "CONST", 
