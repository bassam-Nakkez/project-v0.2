...
public class DartLexer extends Lexer {
	...
	public static final int
		...
		Context=99, Index=100, CP=101, DOT=102, E=103, EE=104, EGT=105, GT=106, 
		LE=107, LL=108, LLE=109, LT=110, MIN=111, MINMIN=112, MOD=113, MODE=114, 
		MUL=115, MULE=116, NE=117, OB=118, OP=119, P=120, PE=121, POUND=122, PP=123, 
		Q=124, QD=125, QDD=126, QQ=127, MIE=128, SCO=129, DIV=130, SLE=131, TE=132, 
		POW=133, COT=134, START=135, END=136, AA=137, AND=138, ANDE=139, AT=140, 
		B=141, NOT=142, OR=143, BE=144, CB=145, CO=146, COM=147, ARROW=148, ASSERT=149, 
		BREAK=150, CASE=151, CATCH=152, CLASS=153, CONST=154, CONTINUE=155, DEFAULT=156, 
		DO=157, ELSE=158, ENUM=159, EXTENDS=160, FALSE=161, FINAL=162, FINALLY=163, 
		FOR=164, IF=165, IN=166, IS=167, NEW=168, NULL=169, RETHROW=170, RETURN=171, 
		SUPER=172, SWITCH=173, THIS=174, THROW=175, TRUE=176, TRY=177, VAR=178, 
		VOID=179, WHILE=180, WITH=181, ABSTRACT=182, AS=183, COVARIANT=184, DEFERRED=185, 
		DYNAMIC=186, EXPORT=187, EXTENSION=188, EXTERNAL=189, FACTORY=190, FUNCTION=191, 
		GET=192, IMPLEMENTS=193, IMPORT=194, INTERFACE=195, LATE=196, LIBRARY=197, 
		OPERATOR=198, MIXIN=199, PART=200, REQUIRED=201, SET=202, STATIC=203, 
		TYPEDEF=204, AWAIT=205, YIELD=206, ASYNC=207, HIDE=208, OF=209, ON=210, 
		SHOW=211, SYNC=212, NATIVE=213, OVERRIDE=214, BOOL_VALUE=215, INT_NUM=216, 
		FLOAT_NUM=217, DOUBLE_NUM=218, HEXDIGIT=219, BOOLE_TYPE=220, STRING=221, 
		STRING_singl=222, ID=223, COMMENT=224, MULTI_LINE_COMMENT=225, WS=226;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"OR", "BE", "CB", "CO", "COM", "ARROW", "LETTER", "DIGIT", "EXPONENT", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"STRING_singl", "ID", "COMMENT", "MULTI_LINE_COMMENT", "WS"
		};
	}
